...
def main():
    print(f"Attempting to configure producer for Kafka broker at {bootstrap_servers}...")
    ...
    if remaining_messages > 0:
        print(f"WARN: {remaining_messages} message(s) were not delivered after flush timeout.")
